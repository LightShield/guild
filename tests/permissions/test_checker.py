...
class TestAskTier:
    ...
    def test_ask_tier_calls_prompt_function(self) -> None:
        ...
        checker = PermissionChecker(PermissionConfig(tier=PermissionTier.ASK, prompt_fn=prompt_fn))
...
class TestReversibilitySafeOperations:
    ...
    def test_safe_operations_allowed(self, command: str, tier_setup: tuple) -> None:
        ...
        checker = PermissionChecker(PermissionConfig(tier=tier, **kwargs))
...
class TestPermissionsCheckerEdges:
    ...
    def test_set_tier_updates_allowed_paths(self) -> None:
        ...
        checker = PermissionChecker(PermissionConfig(tier=PermissionTier.ASK))
        checker.set_tier(
